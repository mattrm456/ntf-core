...
IF NOT DEFINED NTF_CONFIGURE_FROM_CONTINUOUS_INTEGRATION (
    set NTF_CONFIGURE_FROM_CONTINUOUS_INTEGRATION=0
)

IF NOT DEFINED NTF_CONFIGURE_FROM_PACKAGING (
    set NTF_CONFIGURE_FROM_PACKAGING=0
)
...
IF NOT DEFINED NTF_CONFIGURE_WITH_ZERO_COPY (
    set NTF_CONFIGURE_WITH_ZERO_COPY=0
)
