...
BSLS_IDENT_RCSID(ntsa_ipv4optionvalue_t_cpp, "$Id$ $CSID$")
...
// Provide tests for 'ntsa::Ipv4OptionValue'.
class Ipv4OptionValueTest
{
  public:
...
NTSCFG_TEST_FUNCTION(ntsa::Ipv4OptionValueTest::verifyTypeTraits)
{
    const bool isAllocatorAware =
        NTSCFG_TYPE_CHECK_ALLOCATOR_AWARE(ntsa::Ipv4OptionValue);
