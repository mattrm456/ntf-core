...
#ifndef INCLUDED_NTSA_TCPCHECKSUM
#define INCLUDED_NTSA_TCPCHECKSUM
...
/// Provide a Transmission Control Protocol (TCP) checksum.
///
/// @par Thread Safety
...
class TcpChecksum
{
  ...
  public:
    /// Create a new TCP checksum.
    TcpChecksum();

    /// Create a new TCP checksum having the same value as the specified
    /// 'original' object.
    TcpChecksum(const TcpChecksum& original);
    ...
    TcpChecksum& operator=(const TcpChecksum& other);
