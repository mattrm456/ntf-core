...
#ifndef INCLUDED_NTSA_PACKETENCODEROPTIONS
#define INCLUDED_NTSA_PACKETENCODEROPTIONS
...
/// Describe the options of a packet encoder.
///
...
class PacketEncoderOptions
{
  ...
  public:
    ...
    /// Create new packet encoder options having the same value as the
    /// specified 'original' object. Assign an unspecified but valid value to
    /// the 'original' original.
    PacketEncoderOptions(bslmf::MovableRef<PacketEncoderOptions> original)
        NTSCFG_NOEXCEPT;

    /// Create new packet encoder options having the same value as the
    /// specified 'original' object.
    PacketEncoderOptions(const PacketEncoderOptions& original);
    ...
    PacketEncoderOptions& operator=(
        bslmf::MovableRef<PacketEncoderOptions> other) NTSCFG_NOEXCEPT;

    /// Assign the value of the specified 'other' object to this object.
    /// Return a reference to this modifiable object.
    PacketEncoderOptions& operator=(const PacketEncoderOptions& other);
    ...
    bool equals(const PacketEncoderOptions& other) const;

    /// Return true if the value of this object is less than the value of the
    /// specified 'other' object, otherwise return false.
    bool less(const PacketEncoderOptions& other) const;
    ...
    NTSCFG_TYPE_TRAIT_BITWISE_INITIALIZABLE(PacketEncoderOptions);

    /// This type's copy-constructor and copy-assignment operator is equivalent
    /// to copying each byte of the source object's footprint to each
    /// corresponding byte of the destination object's footprint.
    NTSCFG_TYPE_TRAIT_BITWISE_COPYABLE(PacketEncoderOptions);

    /// This type's move-constructor and move-assignment operator is equivalent
    /// to copying each byte of the source object's footprint to each
    /// corresponding byte of the destination object's footprint.
    NTSCFG_TYPE_TRAIT_BITWISE_MOVABLE(PacketEncoderOptions);
};
...
/// 'stream'.
///
/// @related ntsa::PacketEncoderOptions
bsl::ostream& operator<<(bsl::ostream&               stream,
                         const PacketEncoderOptions& object);

/// Return true if the specified 'lhs' has the same value as the specified
/// 'rhs', otherwise return false.
///
/// @related ntsa::PacketEncoderOptions
bool operator==(const PacketEncoderOptions& lhs,
                const PacketEncoderOptions& rhs);
...
/// @related ntsa::PacketEncoderOptions
template <typename HASH_ALGORITHM>
void hashAppend(HASH_ALGORITHM& algorithm, const PacketEncoderOptions& value);

NTSCFG_INLINE
PacketEncoderOptions::PacketEncoderOptions()
...
NTSCFG_INLINE
PacketEncoderOptions::PacketEncoderOptions(
    bslmf::MovableRef<PacketEncoderOptions> original) NTSCFG_NOEXCEPT
...
NTSCFG_INLINE
PacketEncoderOptions::PacketEncoderOptions(
    const PacketEncoderOptions& original)
...
NTSCFG_INLINE
PacketEncoderOptions& PacketEncoderOptions::operator=(
    bslmf::MovableRef<PacketEncoderOptions> other) NTSCFG_NOEXCEPT
{
...
NTSCFG_INLINE
PacketEncoderOptions& PacketEncoderOptions::operator=(
    const PacketEncoderOptions& other)
{
...
NTSCFG_INLINE
void PacketEncoderOptions::reset()
{
...
NTSCFG_INLINE
void PacketEncoderOptions::setSourceEthernetAddress(
...
NTSCFG_INLINE
void PacketEncoderOptions::setSourceIpAddress(const ntsa::IpAddress& value)
{
    d_sourceIpAddress = value;
}

NTSCFG_INLINE
void PacketEncoderOptions::setSourceTcpPort(ntsa::Port value)
{
    d_sourceTcpPort = value;
}

NTSCFG_INLINE
void PacketEncoderOptions::setSourceUdpPort(ntsa::Port value)
{
    d_sourceUdpPort = value;
}

NTSCFG_INLINE
void PacketEncoderOptions::setDestinationEthernetAddress(
    const ntsa::EthernetAddress& value)
{
...
NTSCFG_INLINE
void PacketEncoderOptions::setDestinationIpAddress(
...
NTSCFG_INLINE
void PacketEncoderOptions::setDestinationTcpPort(ntsa::Port value)
{
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::EthernetAddress>& PacketEncoderOptions::
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::IpAddress>& PacketEncoderOptions::
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::Port>& PacketEncoderOptions::sourceTcpPort()
    const
{
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::Port>& PacketEncoderOptions::sourceUdpPort()
    const
{
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::Port>& PacketEncoderOptions::
...
NTSCFG_INLINE void hashAppend(HASH_ALGORITHM&             algorithm,
                              const PacketEncoderOptions& value)
{
