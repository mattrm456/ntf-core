...
#ifndef INCLUDED_NTSA_ICMPCHECKSUM
#define INCLUDED_NTSA_ICMPCHECKSUM
...
/// Provide an Internet Control Message Protocol (ICMP) checksum.
///
/// @par Thread Safety
...
class IcmpChecksum
{
    ...
    enum Constant {
        /// The protocol number indicating ICMP.
        k_PROTOCOL_ICMP = 1
    };
  ...
  public:
    /// Create a new ICMP checksum.
    IcmpChecksum();

    /// Create a new ICMP checksum having the same value as the specified
    /// 'original' object.
    IcmpChecksum(const IcmpChecksum& original);
    ...
    IcmpChecksum& operator=(const IcmpChecksum& other);
    ...
    /// of the ICMP packet, including the ICMP header.
