...
#ifndef INCLUDED_NTSA_PACKETENCODERCONTEXT
#define INCLUDED_NTSA_PACKETENCODERCONTEXT
...
/// Describe the context of a packet encoder.
///
/// @ingroup module_ntsa_protocol
class PacketEncoderContext
{
  ...
  public:
    /// Create a new packet encoder context having a default value.
    PacketEncoderContext();

    /// Create a new packet encoder context having the same value as the
    /// specified 'original' object. Assign an unspecified but valid value to
    /// the 'original' original.
    PacketEncoderContext(bslmf::MovableRef<PacketEncoderContext> original)
        NTSCFG_NOEXCEPT;

    /// Create a new packet encoder context having the same value as the
    /// specified 'original' object.
    PacketEncoderContext(const PacketEncoderContext& original);
    ...
    PacketEncoderContext& operator=(
        bslmf::MovableRef<PacketEncoderContext> other) NTSCFG_NOEXCEPT;

    /// Assign the value of the specified 'other' object to this object.
    /// Return a reference to this modifiable object.
    PacketEncoderContext& operator=(const PacketEncoderContext& other);
    ...
    bool equals(const PacketEncoderContext& other) const;

    /// Return true if the value of this object is less than the value of the
    /// specified 'other' object, otherwise return false.
    bool less(const PacketEncoderContext& other) const;
    ...
    NTSCFG_TYPE_TRAIT_BITWISE_INITIALIZABLE(PacketEncoderContext);

    /// This type's copy-constructor and copy-assignment operator is equivalent
    /// to copying each byte of the source object's footprint to each
    /// corresponding byte of the destination object's footprint.
    NTSCFG_TYPE_TRAIT_BITWISE_COPYABLE(PacketEncoderContext);

    /// This type's move-constructor and move-assignment operator is equivalent
    /// to copying each byte of the source object's footprint to each
    /// corresponding byte of the destination object's footprint.
    NTSCFG_TYPE_TRAIT_BITWISE_MOVABLE(PacketEncoderContext);
};
...
/// 'stream'.
///
/// @related ntsa::PacketEncoderContext
bsl::ostream& operator<<(bsl::ostream&               stream,
                         const PacketEncoderContext& object);

/// Return true if the specified 'lhs' has the same value as the specified
/// 'rhs', otherwise return false.
///
/// @related ntsa::PacketEncoderContext
bool operator==(const PacketEncoderContext& lhs,
                const PacketEncoderContext& rhs);
...
/// @related ntsa::PacketEncoderContext
template <typename HASH_ALGORITHM>
void hashAppend(HASH_ALGORITHM& algorithm, const PacketEncoderContext& value);

NTSCFG_INLINE
PacketEncoderContext::PacketEncoderContext()
...
NTSCFG_INLINE
PacketEncoderContext::PacketEncoderContext(
    bslmf::MovableRef<PacketEncoderContext> original) NTSCFG_NOEXCEPT
...
NTSCFG_INLINE
PacketEncoderContext::PacketEncoderContext(
    const PacketEncoderContext& original)
...
NTSCFG_INLINE
PacketEncoderContext& PacketEncoderContext::operator=(
    bslmf::MovableRef<PacketEncoderContext> other) NTSCFG_NOEXCEPT
{
...
NTSCFG_INLINE
PacketEncoderContext& PacketEncoderContext::operator=(
    const PacketEncoderContext& other)
{
...
NTSCFG_INLINE
void PacketEncoderContext::reset()
{
...
NTSCFG_INLINE
void PacketEncoderContext::setSourceEthernetAddress(
...
NTSCFG_INLINE
void PacketEncoderContext::setSourceIpAddress(const ntsa::IpAddress& value)
{
    d_sourceIpAddress = value;
}

NTSCFG_INLINE
void PacketEncoderContext::setSourceTcpPort(ntsa::Port value)
{
    d_sourceTcpPort = value;
}

NTSCFG_INLINE
void PacketEncoderContext::setSourceUdpPort(ntsa::Port value)
{
    d_sourceUdpPort = value;
}

NTSCFG_INLINE
void PacketEncoderContext::setDestinationEthernetAddress(
    const ntsa::EthernetAddress& value)
{
...
NTSCFG_INLINE
void PacketEncoderContext::setDestinationIpAddress(
...
NTSCFG_INLINE
void PacketEncoderContext::setDestinationTcpPort(ntsa::Port value)
{
    d_destinationTcpPort = value;
}

NTSCFG_INLINE
void PacketEncoderContext::setDestinationUdpPort(ntsa::Port value)
{
    d_destinationUdpPort = value;
}

NTSCFG_INLINE
const bdlb::NullableValue<ntsa::EthernetAddress>& PacketEncoderContext::
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::IpAddress>& PacketEncoderContext::
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::Port>& PacketEncoderContext::sourceTcpPort()
    const
{
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::Port>& PacketEncoderContext::sourceUdpPort()
    const
{
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::Port>& PacketEncoderContext::
...
template <typename HASH_ALGORITHM>
NTSCFG_INLINE void PacketEncoderContext::hash(HASH_ALGORITHM& algorithm) const
{
...
NTSCFG_INLINE void hashAppend(HASH_ALGORITHM&             algorithm,
                              const PacketEncoderContext& value)
{
