...
#ifndef INCLUDED_NTSA_ARPREQUEST
#define INCLUDED_NTSA_ARPREQUEST
...
/// Provide the body of an ARP type 1 request message.
///
/// @details
/// TODO
///
...
class ArpRequest
{
    ...
    /// The hardware address of the device that should respond to the request.
    ntsa::EthernetAddress d_targetHardwareAddress;

    /// The protocol address of the device that should respond to the request.
  ...
  public:
    ...
    /// 'original' original.
    ArpRequest(bslmf::MovableRef<ArpRequest> original) NTSCFG_NOEXCEPT;

    /// Create a new ARP redirect having the same value as the specified
    /// 'original' object.
    ArpRequest(const ArpRequest& original);
    ...
    ArpRequest& operator=(const ArpRequest& other);
    ...
    /// Set the hardware address of the device that should respond to the
    /// request to the specified 'value'.
    void setTargetHardwareAddress(const ntsa::EthernetAddress& value);

    /// Set the protocol address of the device that should respond to the
    /// request to the specified 'value'.
    ...
    /// Return the hardware address of the device that should respond to the
    /// request.
    const ntsa::EthernetAddress& targetHardwareAddress() const;

    /// Return the protocol address of the device that should respond to the
    /// request.
    const ntsa::Ipv4Address& targetProtocolAddress() const;

    /// Return true if this object has the same value as the specified 'other'
    /// object, otherwise return false.
    bool equals(const ArpRequest& other) const;

    /// Return true if the value of this object is less than the value of the
    /// specified 'other' object, otherwise return false.
    bool less(const ArpRequest& other) const;
    ...
    NTSCFG_TYPE_TRAIT_BITWISE_INITIALIZABLE(ArpRequest);

    /// This type's copy-constructor and copy-assignment operator is equivalent
    /// to copying each byte of the source object's footprint to each
    /// corresponding byte of the destination object's footprint.
    NTSCFG_TYPE_TRAIT_BITWISE_COPYABLE(ArpRequest);

    /// This type's move-constructor and move-assignment operator is equivalent
    /// to copying each byte of the source object's footprint to each
    /// corresponding byte of the destination object's footprint.
    NTSCFG_TYPE_TRAIT_BITWISE_MOVABLE(ArpRequest);
};

/// Write a formatted, human-readable description of the specified 'object'
/// into the specified 'stream'. Return a reference to the modifiable 'stream'.
///
/// @related ntsa::ArpRequest
bsl::ostream& operator<<(bsl::ostream& stream, const ArpRequest& object);

/// Return true if the specified 'lhs' has the same value as the specified
/// 'rhs', otherwise return false.
///
/// @related ntsa::ArpRequest
bool operator==(const ArpRequest& lhs, const ArpRequest& rhs);
...
/// @related ntsa::ArpRequest
template <typename HASH_ALGORITHM>
void hashAppend(HASH_ALGORITHM& algorithm, const ArpRequest& value);
...
NTSCFG_INLINE
ArpRequest::ArpRequest(const ArpRequest& original)
{
...
NTSCFG_INLINE
ArpRequest& ArpRequest::operator=(bslmf::MovableRef<ArpRequest> other)
    NTSCFG_NOEXCEPT
{
    NTSCFG_MEMORY_COPY(
        this,
...
NTSCFG_INLINE
ArpRequest& ArpRequest::operator=(const ArpRequest& other)
{
...
NTSCFG_INLINE
void ArpRequest::reset()
{
    NTSCFG_MEMORY_ZERO(this, sizeof *this);
}

NTSCFG_INLINE
void ArpRequest::setSenderHardwareAddress(const ntsa::EthernetAddress& value)
{
    d_senderHardwareAddress = value;
}

NTSCFG_INLINE
void ArpRequest::setSenderProtocolAddress(const ntsa::Ipv4Address& value)
{
    d_senderProtocolAddress = value;
}

NTSCFG_INLINE
void ArpRequest::setTargetHardwareAddress(const ntsa::EthernetAddress& value)
{
    d_targetHardwareAddress = value;
}

NTSCFG_INLINE
void ArpRequest::setTargetProtocolAddress(const ntsa::Ipv4Address& value)
{
    d_targetProtocolAddress = value;
}

NTSCFG_INLINE
const ntsa::EthernetAddress& ArpRequest::senderHardwareAddress() const
{
    return d_senderHardwareAddress;
}

NTSCFG_INLINE
const ntsa::Ipv4Address& ArpRequest::senderProtocolAddress() const
{
    return d_senderProtocolAddress;
}

NTSCFG_INLINE
const ntsa::EthernetAddress& ArpRequest::targetHardwareAddress() const
{
    return d_targetHardwareAddress;
}

NTSCFG_INLINE
const ntsa::Ipv4Address& ArpRequest::targetProtocolAddress() const
{
    return d_targetProtocolAddress;
}

NTSCFG_INLINE
bool ArpRequest::equals(const ArpRequest& other) const
{
    return NTSCFG_MEMORY_COMPARE(this, &other, sizeof *this) == 0;
}

NTSCFG_INLINE
bool ArpRequest::less(const ArpRequest& other) const
{
    return NTSCFG_MEMORY_COMPARE(this, &other, sizeof *this) < 0;
}

template <typename HASH_ALGORITHM>
NTSCFG_INLINE void ArpRequest::hash(HASH_ALGORITHM& algorithm) const
{
