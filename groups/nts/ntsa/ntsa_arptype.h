...
#ifndef INCLUDED_NTSA_ARPTYPE
#define INCLUDED_NTSA_ARPTYPE
...
/// Enumerate the ARP message types.
///
/// @par Thread Safety
...
struct ArpType {
  public:
    /// Enumerate the ARP message types.
    enum Value {
        /// The ARP message type is not defined.
        e_UNDEFINED = 0,

        /// The ARP message requests an address resolution.
        e_REQUEST = 1,

        /// The ARP message responds to an address resolution.
        e_RESPONSE = 2
    };
