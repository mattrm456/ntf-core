...
BSLS_IDENT_RCSID(ntsa_packetdecoderoptions_cpp, "$Id$ $CSID$")
...
bool PacketDecoderOptions::equals(const PacketDecoderOptions& other) const
{
...
bool PacketDecoderOptions::less(const PacketDecoderOptions& other) const
{
...
bsl::ostream& PacketDecoderOptions::print(bsl::ostream& stream,
                                          int           level,
