...
NTSCFG_TEST_FUNCTION(ntsa::Ipv4PacketTest::verifyIcmpRedirect)
{
    ...
    NTSCFG_TEST_EQ(redirect.header().fragmentOffset(), 0);
    NTSCFG_TEST_EQ(redirect.header().preserve(), true);
...
NTSCFG_TEST_FUNCTION(ntsa::Ipv4PacketTest::verifyIcmpUnreachable)
{
    ...
    NTSCFG_TEST_EQ(unreachable.header().fragmentOffset(), 0);
    NTSCFG_TEST_EQ(unreachable.header().preserve(), true);
...
NTSCFG_TEST_FUNCTION(ntsa::Ipv4PacketTest::verifyIcmpTimeout)
{
    ...
    NTSCFG_TEST_EQ(timeout.header().fragmentOffset(), 0);
    NTSCFG_TEST_EQ(timeout.header().preserve(), true);
...
NTSCFG_TEST_FUNCTION(ntsa::Ipv4PacketTest::verifyIcmpProblem)
{
    ...
    NTSCFG_TEST_EQ(problem.header().fragmentOffset(), 0);
    NTSCFG_TEST_EQ(problem.header().preserve(), true);
