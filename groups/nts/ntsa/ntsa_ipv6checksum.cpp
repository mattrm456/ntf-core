...
BSLS_IDENT_RCSID(ntsa_ipv6checksum_cpp, "$Id$ $CSID$")
...
Ipv6Checksum::Ipv6Checksum(const Ipv6Checksum& original)
...
Ipv6Checksum& Ipv6Checksum::operator=(const Ipv6Checksum& other)
{
    if (this != &other) {
...
void Ipv6Checksum::reset()
{
    d_accumulator = 0;
}

void Ipv6Checksum::add(const void* data, bsl::size_t size)
{
...
bsl::uint32_t Ipv6Checksum::accumulator() const
{
    return d_accumulator;
}

bsl::uint16_t Ipv6Checksum::value() const
{
