...
BSLS_IDENT_RCSID(ntsa_arpresponse_cpp, "$Id$ $CSID$")
...
ntsa::Error ArpResponse::decode(ntsa::PacketDecoder* decoder)
{
    ntsa::Error error;
...
ntsa::Error ArpResponse::encode(ntsa::PacketEncoder* encoder) const
{
    ntsa::Error error;
...
void ArpResponse::print(bslim::Printer* printer) const
{
