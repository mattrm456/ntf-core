...
#ifndef INCLUDED_NTSA_PACKETDECODEROPTIONS
#define INCLUDED_NTSA_PACKETDECODEROPTIONS
...
/// Describe the options of a packet decoder.
///
/// @ingroup module_ntsa_protocol
class PacketDecoderOptions
{
  ...
  public:
    ...
    PacketDecoderOptions(bslmf::MovableRef<PacketDecoderOptions> original)
        NTSCFG_NOEXCEPT;

    /// Create new packet decoder options having the same value as the
    /// specified 'original' object.
    PacketDecoderOptions(const PacketDecoderOptions& original);
    ...
    PacketDecoderOptions& operator=(
        bslmf::MovableRef<PacketDecoderOptions> other) NTSCFG_NOEXCEPT;

    /// Assign the value of the specified 'other' object to this object.
    /// Return a reference to this modifiable object.
    PacketDecoderOptions& operator=(const PacketDecoderOptions& other);
    ...
    bool equals(const PacketDecoderOptions& other) const;

    /// Return true if the value of this object is less than the value of the
    /// specified 'other' object, otherwise return false.
    bool less(const PacketDecoderOptions& other) const;
    ...
    NTSCFG_TYPE_TRAIT_BITWISE_INITIALIZABLE(PacketDecoderOptions);

    /// This type's copy-constructor and copy-assignment operator is equivalent
    /// to copying each byte of the source object's footprint to each
    /// corresponding byte of the destination object's footprint.
    NTSCFG_TYPE_TRAIT_BITWISE_COPYABLE(PacketDecoderOptions);

    /// This type's move-constructor and move-assignment operator is equivalent
    /// to copying each byte of the source object's footprint to each
    /// corresponding byte of the destination object's footprint.
    NTSCFG_TYPE_TRAIT_BITWISE_MOVABLE(PacketDecoderOptions);
};
...
/// 'stream'.
///
/// @related ntsa::PacketDecoderOptions
bsl::ostream& operator<<(bsl::ostream&               stream,
                         const PacketDecoderOptions& object);

/// Return true if the specified 'lhs' has the same value as the specified
/// 'rhs', otherwise return false.
///
/// @related ntsa::PacketDecoderOptions
bool operator==(const PacketDecoderOptions& lhs,
                const PacketDecoderOptions& rhs);
...
/// @related ntsa::PacketDecoderOptions
template <typename HASH_ALGORITHM>
void hashAppend(HASH_ALGORITHM& algorithm, const PacketDecoderOptions& value);

NTSCFG_INLINE
PacketDecoderOptions::PacketDecoderOptions()
...
NTSCFG_INLINE
PacketDecoderOptions::PacketDecoderOptions(
    bslmf::MovableRef<PacketDecoderOptions> original) NTSCFG_NOEXCEPT
...
NTSCFG_INLINE
PacketDecoderOptions::PacketDecoderOptions(
    const PacketDecoderOptions& original)
...
NTSCFG_INLINE
PacketDecoderOptions& PacketDecoderOptions::operator=(
    bslmf::MovableRef<PacketDecoderOptions> other) NTSCFG_NOEXCEPT
{
...
NTSCFG_INLINE
PacketDecoderOptions& PacketDecoderOptions::operator=(
    const PacketDecoderOptions& other)
{
...
NTSCFG_INLINE
void PacketDecoderOptions::reset()
{
...
NTSCFG_INLINE
void PacketDecoderOptions::setSourceEthernetAddress(
...
NTSCFG_INLINE
void PacketDecoderOptions::setSourceIpAddress(const ntsa::IpAddress& value)
{
    d_sourceIpAddress = value;
}

NTSCFG_INLINE
void PacketDecoderOptions::setSourceTcpPort(ntsa::Port value)
{
    d_sourceTcpPort = value;
}

NTSCFG_INLINE
void PacketDecoderOptions::setSourceUdpPort(ntsa::Port value)
{
    d_sourceUdpPort = value;
}

NTSCFG_INLINE
void PacketDecoderOptions::setDestinationEthernetAddress(
    const ntsa::EthernetAddress& value)
{
...
NTSCFG_INLINE
void PacketDecoderOptions::setDestinationIpAddress(
...
NTSCFG_INLINE
void PacketDecoderOptions::setDestinationTcpPort(ntsa::Port value)
{
    d_destinationTcpPort = value;
}

NTSCFG_INLINE
void PacketDecoderOptions::setDestinationUdpPort(ntsa::Port value)
{
    d_destinationUdpPort = value;
}

NTSCFG_INLINE
void PacketDecoderOptions::setLoopback(bool value)
{
    if (value) {
        d_flags |= k_LOOPBACK;
    }
...
NTSCFG_INLINE
void PacketDecoderOptions::setIgnoreChecksum(bool value)
{
    if (value) {
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::EthernetAddress>& PacketDecoderOptions::
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::IpAddress>& PacketDecoderOptions::
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::Port>& PacketDecoderOptions::sourceTcpPort()
    const
{
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::Port>& PacketDecoderOptions::sourceUdpPort()
    const
{
...
NTSCFG_INLINE
const bdlb::NullableValue<ntsa::Port>& PacketDecoderOptions::
...
NTSCFG_INLINE
bool PacketDecoderOptions::loopback() const
{
    return (d_flags & k_LOOPBACK) != 0;
}

NTSCFG_INLINE
bool PacketDecoderOptions::ignoreChecksum() const
{
    return (d_flags & k_IGNORE_CHECKSUM) != 0;
}

template <typename HASH_ALGORITHM>
NTSCFG_INLINE void PacketDecoderOptions::hash(HASH_ALGORITHM& algorithm) const
{
...
NTSCFG_INLINE void hashAppend(HASH_ALGORITHM&             algorithm,
                              const PacketDecoderOptions& value)
{
