...
BSLS_IDENT_RCSID(ntsa_packetencodercontext_cpp, "$Id$ $CSID$")
...
bool PacketEncoderContext::equals(const PacketEncoderContext& other) const
{
...
bool PacketEncoderContext::less(const PacketEncoderContext& other) const
{
...
bsl::ostream& PacketEncoderContext::print(bsl::ostream& stream,
                                          int           level,
