...
if (NOT DEFINED NTF_BUILD_FROM_CONTINUOUS_INTEGRATION)
    ...
    elseif (DEFINED ENV{NTF_CONFIGURE_FROM_CONTINUOUS_INTEGRATION})
        ...
        set(NTF_BUILD_FROM_CONTINUOUS_INTEGRATION FALSE CACHE INTERNAL "")
    endif()
endif()
...
if (NOT DEFINED NTF_BUILD_UNITY)
    ...
    elseif (DEFINED ENV{NTF_CONFIGURE_UNITY})
        ...
        set(NTF_BUILD_UNITY FALSE CACHE INTERNAL "")
    endif()
endif()
...
if (NOT DEFINED NTF_BUILD_WITH_LZ4)
    ...
    elseif (DEFINED ENV{NTF_CONFIGURE_WITH_LZ4})
        ...
        set(NTF_BUILD_WITH_LZ4 TRUE CACHE INTERNAL "")
    endif()
endif()
...
if (NOT DEFINED NTF_BUILD_WITH_ZSTD)
    ...
    elseif (DEFINED ENV{NTF_CONFIGURE_WITH_ZSTD})
        ...
        set(NTF_BUILD_WITH_ZSTD TRUE CACHE INTERNAL "")
    endif()
endif()
...
if (NOT DEFINED NTF_BUILD_WITH_ZLIB)
    ...
    elseif (DEFINED ENV{NTF_CONFIGURE_WITH_ZLIB})
        ...
        set(NTF_BUILD_WITH_ZLIB TRUE CACHE INTERNAL "")
    endif()
endif()
...
if (NOT DEFINED NTF_BUILD_WITH_TIMESTAMPING)
    if (DEFINED NTF_CONFIGURE_WITH_TIMESTAMPING)
        set(NTF_BUILD_WITH_TIMESTAMPING
            ${NTF_CONFIGURE_WITH_TIMESTAMPING} CACHE INTERNAL "")
    elseif (DEFINED ENV{NTF_CONFIGURE_WITH_TIMESTAMPING})
        set(NTF_BUILD_WITH_TIMESTAMPING
            $ENV{NTF_CONFIGURE_WITH_TIMESTAMPING} CACHE INTERNAL "")
    else()
        if(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
            if (${NTF_BUILD_FROM_CONTINUOUS_INTEGRATION})
                set(NTF_BUILD_WITH_TIMESTAMPING FALSE CACHE INTERNAL "")
            else()
                set(NTF_BUILD_WITH_TIMESTAMPING TRUE CACHE INTERNAL "")
            endif()
        else()
            set(NTF_BUILD_WITH_TIMESTAMPING FALSE CACHE INTERNAL "")
        endif()
...
if (NOT DEFINED NTF_BUILD_WITH_ZERO_COPY)
    if (DEFINED NTF_CONFIGURE_WITH_ZERO_COPY)
        set(NTF_BUILD_WITH_ZERO_COPY
            ${NTF_CONFIGURE_WITH_ZERO_COPY} CACHE INTERNAL "")
    elseif (DEFINED ENV{NTF_CONFIGURE_WITH_ZERO_COPY})
        set(NTF_BUILD_WITH_ZERO_COPY
            $ENV{NTF_CONFIGURE_WITH_ZERO_COPY} CACHE INTERNAL "")
    else()
        if(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
            if (${NTF_BUILD_FROM_CONTINUOUS_INTEGRATION})
                set(NTF_BUILD_WITH_ZERO_COPY FALSE CACHE INTERNAL "")
            else()
                set(NTF_BUILD_WITH_ZERO_COPY TRUE CACHE INTERNAL "")
            endif()
        else()
            set(NTF_BUILD_WITH_ZERO_COPY FALSE CACHE INTERNAL "")
        endif()
...
if (${NTF_BUILD_WITH_TIMESTAMPING})
    message(STATUS "NTF: Building with packet timestamping:         yes")
else()
    message(STATUS "NTF: Building with packet timestamping:         no")
endif()

if (${NTF_BUILD_WITH_ZERO_COPY})
    message(STATUS "NTF: Building with zero-copy system calls:      yes")
else()
    message(STATUS "NTF: Building with zero-copy system calls:      no")
endif()
