...
if (${NTF_BUILD_WITH_NTS})
    ...
    ntf_component(NAME ntsa_allocator)
    ntf_component(NAME ntsa_arpheader)
    ntf_component(NAME ntsa_arppacket)
    ntf_component(NAME ntsa_arppayload)
    ntf_component(NAME ntsa_arprequest)
    ntf_component(NAME ntsa_arpresponse)
    ntf_component(NAME ntsa_arptype)
    ntf_component(NAME ntsa_backoff)
    ntf_component(NAME ntsa_buffer)
    ntf_component(NAME ntsa_circular)
    ntf_component(NAME ntsa_coroutine)
    ntf_component(NAME ntsa_data)
    ntf_component(NAME ntsa_datatype)
    ntf_component(NAME ntsa_deviceconfig)
    ntf_component(NAME ntsa_devicetype)
    ...
    ntf_component(NAME ntsa_ethernetpacket)
    ntf_component(NAME ntsa_ethernetpayload)
    ntf_component(NAME ntsa_ethernetpriority)
    ntf_component(NAME ntsa_ethernetprotocol)
    ntf_component(NAME ntsa_ethernetroute)
    ntf_component(NAME ntsa_ethernetroutetable)
    ntf_component(NAME ntsa_ethernettag)
    ...
    ntf_component(NAME ntsa_icmpchecksum)
    ntf_component(NAME ntsa_icmpheader)
    ntf_component(NAME ntsa_icmppacket)
    ntf_component(NAME ntsa_icmppayload)
    ntf_component(NAME ntsa_icmpechorequest)
    ntf_component(NAME ntsa_icmpechoresponse)
    ntf_component(NAME ntsa_icmpproblem)
    ntf_component(NAME ntsa_icmpredirect)
    ntf_component(NAME ntsa_icmprouterinfo)
    ntf_component(NAME ntsa_icmprouterrequest)
    ntf_component(NAME ntsa_icmprouterresponse)
    ntf_component(NAME ntsa_icmptimeout)
    ntf_component(NAME ntsa_icmptype)
    ntf_component(NAME ntsa_icmpunreachable)
    ntf_component(NAME ntsa_igmpchecksum)
    ntf_component(NAME ntsa_igmpheader)
    ntf_component(NAME ntsa_igmpjoin)
    ntf_component(NAME ntsa_igmpleave)
    ntf_component(NAME ntsa_igmppacket)
    ntf_component(NAME ntsa_igmppayload)
    ntf_component(NAME ntsa_igmpquery)
    ntf_component(NAME ntsa_igmprecord)
    ntf_component(NAME ntsa_igmprecordtype)
    ntf_component(NAME ntsa_igmpreport)
    ntf_component(NAME ntsa_igmptype)
    ...
    ntf_component(NAME ntsa_ipv4checksum)
    ntf_component(NAME ntsa_ipv4endpoint)
    ntf_component(NAME ntsa_ipv4extension)
    ntf_component(NAME ntsa_ipv4header)
    ntf_component(NAME ntsa_ipv4option)
    ntf_component(NAME ntsa_ipv4optiontype)
    ntf_component(NAME ntsa_ipv4optionvalue)
    ntf_component(NAME ntsa_ipv4packet)
    ntf_component(NAME ntsa_ipv4payload)
    ntf_component(NAME ntsa_ipv4route)
    ntf_component(NAME ntsa_ipv4routeledger)
    ntf_component(NAME ntsa_ipv4routesequence)
    ntf_component(NAME ntsa_ipv4routetable)
    ntf_component(NAME ntsa_ipv4timestamp)
    ntf_component(NAME ntsa_ipv6address)
    ntf_component(NAME ntsa_ipv6checksum)
    ntf_component(NAME ntsa_ipv6endpoint)
    ntf_component(NAME ntsa_ipv6extension)
    ntf_component(NAME ntsa_ipv6header)
    ntf_component(NAME ntsa_ipv6packet)
    ntf_component(NAME ntsa_ipv6payload)
    ntf_component(NAME ntsa_ipv6route)
    ntf_component(NAME ntsa_ipv6routetable)
    ...
    ntf_component(NAME ntsa_packet)
    ntf_component(NAME ntsa_packetdecoder)
    ntf_component(NAME ntsa_packetdecodercontext)
    ntf_component(NAME ntsa_packetdecoderoptions)
    ntf_component(NAME ntsa_packetencoder)
    ntf_component(NAME ntsa_packetencodercontext)
    ntf_component(NAME ntsa_packetencoderoptions)
    ntf_component(NAME ntsa_packetfactory)
    ntf_component(NAME ntsa_packetfilter)
    ntf_component(NAME ntsa_packetpool)
    ntf_component(NAME ntsa_packetqueue)
    ntf_component(NAME ntsa_packettype)
    ...
    ntf_component(NAME ntsa_tcpchecksum)
    ntf_component(NAME ntsa_tcpcongestioncontrol)
    ntf_component(NAME ntsa_tcpcongestioncontrolalgorithm)
    ntf_component(NAME ntsa_tcpextension)
    ntf_component(NAME ntsa_tcpheader)
    ntf_component(NAME ntsa_tcpoption)
    ntf_component(NAME ntsa_tcpoptiontype)
    ntf_component(NAME ntsa_tcpoptionvalue)
    ntf_component(NAME ntsa_tcppayload)
    ntf_component(NAME ntsa_tcppacket)
    ntf_component(NAME ntsa_tcpsequencenumber)
    ntf_component(NAME ntsa_tcptimepoint)
    ...
    ntf_component(NAME ntsa_udpchecksum)
    ntf_component(NAME ntsa_udpextension)
    ntf_component(NAME ntsa_udpfragmentation)
    ntf_component(NAME ntsa_udpheader)
    ntf_component(NAME ntsa_udpoption)
    ntf_component(NAME ntsa_udpoptiontype)
    ntf_component(NAME ntsa_udpoptionvalue)
    ...
    ntf_component(NAME ntsi_device)
    ...
    ntf_component(NAME ntsu_deviceutil)
    ntf_component(NAME ntsu_packetutil)
    ntf_component(NAME ntsu_resolverutil)
    ntf_component(NAME ntsu_routeutil)
    ...
    ntf_component(NAME ntso_device)
...
if (${NTF_BUILD_WITH_NTC})
    ...
    ntf_component(NAME ntca_connectstrategy)
    ...
    ntf_component(NAME ntca_downgradeoptions)
    ...
    ntf_component(NAME ntci_concurrent)
    ...
    ntf_component(NAME ntci_interactable)
    ...
    ntf_component(NAME ntcs_interactable)
